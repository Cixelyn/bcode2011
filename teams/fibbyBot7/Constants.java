...
public class Constants
{
	...
	public static final int RESERVE = 3; // desired min flux
	...
	public static final int SCV_SEARCH_FREQ = 7; // how often SCVs should stop and spin to find mines and off_maps... no higher than ~5?
	...
	public static final int MARINE_TIME = 700;
	public static final int LATE_GAME = 1100;
	public static final int BUILDING_CYCLE = 4;
